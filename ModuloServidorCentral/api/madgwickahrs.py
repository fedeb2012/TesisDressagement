...
class MadgwickAHRS:
    ...
    def update(self, gyroscope, accelerometer, magnetometer):
        ...
        h = q * \
            (Quaternion(
                0, magnetometer[0], magnetometer[1], magnetometer[2]) * q.conj())
        ...
        j = np.array([
            ...
            [-2*b[1]*q[3]+2*b[3]*q[1], 2*b[1]*q[2]+2*b[3]*q[0], 2 *
                b[1]*q[1]+2*b[3]*q[3],  -2*b[1]*q[0]+2*b[3]*q[2]],
            [2*b[1]*q[2],              2*b[1]*q[3]-4*b[3] *
                q[1], 2*b[1]*q[0]-4*b[3]*q[2],  2*b[1]*q[1]]
        ])
        step = j.T.dot(f)
        ...
        qdot = (
            q * Quaternion(0, gyroscope[0], gyroscope[1], gyroscope[2])) * 0.5 - self.beta * step.T
